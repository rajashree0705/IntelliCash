...
class TranslationsIntroEn {
	...
	String get last_slide_descr => 'With Intellicash, you can finally achieve the financial independence you want so much. You will have graphs, budgets, tips, statistics and much more about your money.';
...
class TranslationsHomeEn {
	...
	String get no_accounts_descr => 'Start using all the magic of Intellicash. Create at least one account to start adding transactions';
...
class TranslationsSettingsEn {
	...
	String get lang_help => 'If you want to collaborate with the translations of this app, you can consult <a href=\'https://github.com/enrique-lozano/Intellicash/tree/main/lib/i18n\'>our guide</a>';
...
class TranslationsTransactionStatusEn {
	...
	String get unreconciled_descr => 'This transaction has not yet been validated and therefore does not yet appear in your real bank accounts. However, it counts for the calculation of balances and statistics in Intellicash';
...
class TranslationsBackupImportEn {
	...
	String get restore_backup_descr => 'Import a previously saved database from Intellicash. This action will replace any current application data with the new data';
	String get restore_backup_warn_description => 'When importing a new database, you will lose all data currently saved in the app. It is recommended to make a backup before continuing. Do not upload here any file whose origin you do not know, upload only files that you have previously downloaded from Intellicash';
...
class TranslationsMoreAboutUsEn {
	...
	String get description => 'Check out the terms and other relevant information about Intellicash. Get in touch with the community by reporting bugs, leaving suggestions...';
...
class TranslationsMoreHelpUsEn {
	...
	String get description => 'Find out how you can help Intellicash become better and better';
	String get rate_us => 'Rate us';
	String get rate_us_descr => 'Any rate is welcome!';
	String get share => 'Share Intellicash';
	String get share_descr => 'Share our app to friends and family';
	String get share_text => 'Intellicash! The best personal finance app. Download it here';
	String get thanks => 'Thank you!';
	String get thanks_long => 'Your contributions to Intellicash and other open source projects, big and small, make great projects like this possible. Thank you for taking the time to contribute.';
...
class TranslationsFinancialHealthReviewDescrEn {
	...
	String get very_good => 'Congratulations! Your financial health is tremendous. We hope you continue your good streak and continue learning with Intellicash';
...
class TranslationsMoreAboutUsProjectEn {
	...
	String get contributors_descr => 'All the developers who have made Intellicash grow';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'intro.welcome_footer': return 'By logging in you agree to the <a href=\'https://github.com/enrique-lozano/Intellicash/blob/main/docs/PRIVACY_POLICY.md\'>Privacy Policy</a> and the <a href=\'https://github.com/enrique-lozano/Intellicash/blob/main/docs/TERMS_OF_USE.md\'>Terms of Use</a> of the application';
			...
			case 'intro.last_slide_descr': return 'With Intellicash, you can finally achieve the financial independence you want so much. You will have graphs, budgets, tips, statistics and much more about your money.';
			...
			case 'home.no_accounts_descr': return 'Start using all the magic of Intellicash. Create at least one account to start adding transactions';
			...
			case 'financial_health.review.descr.very_good': return 'Congratulations! Your financial health is tremendous. We hope you continue your good streak and continue learning with Intellicash';
			...
			case 'transaction.status.unreconciled_descr': return 'This transaction has not yet been validated and therefore does not yet appear in your real bank accounts. However, it counts for the calculation of balances and statistics in Intellicash';
			...
			case 'backup.import.restore_backup_descr': return 'Import a previously saved database from Intellicash. This action will replace any current application data with the new data';
			...
			case 'settings.lang_help': return 'If you want to collaborate with the translations of this app, you can consult <a href=\'https://github.com/enrique-lozano/Intellicash/tree/main/lib/i18n\'>our guide</a>';
			...
			case 'more.about_us.description': return 'Check out the terms and other relevant information about Intellicash. Get in touch with the community by reporting bugs, leaving suggestions...';
			...
			case 'more.about_us.project.contributors_descr': return 'All the developers who have made Intellicash grow';
			case 'more.about_us.project.contact': return 'Contact us';
			case 'more.help_us.display': return 'Help us';
			case 'more.help_us.description': return 'Find out how you can help Intellicash become better and better';
			case 'more.help_us.rate_us': return 'Rate us';
			case 'more.help_us.rate_us_descr': return 'Any rate is welcome!';
			case 'more.help_us.share': return 'Share Intellicash';
			case 'more.help_us.share_descr': return 'Share our app to friends and family';
			case 'more.help_us.share_text': return 'Intellicash! The best personal finance app. Download it here';
			case 'more.help_us.thanks': return 'Thank you!';
			case 'more.help_us.thanks_long': return 'Your contributions to Intellicash and other open source projects, big and small, make great projects like this possible. Thank you for taking the time to contribute.';
